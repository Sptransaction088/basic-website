      ...
      <div className="pt-6 pb-5 px-4 md:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
            ...
            {[
              ...
              },
              {
                ...
                links: [
                  ...
                  { name: 'Terms & Conditions', to: '/coming-soon' },
              ...
              },
              {
                title: 'Developers',
                links: [
                  { name: 'Getting Started', to: '/coming-soon' },
                  { name: 'API Documentation', to: '/coming-soon' },
                  { name: 'Integration Guide', to: '/coming-soon' },
                  { name: 'FAQs', to: '/coming-soon' },
                ],
              },
            ].map((section, index) => (
              <div key={index}>
                <h4 className="text-xl font-bold mb-4" style={{ color: colors.purple }}>
                  {section.title}
                </h4>
                <ul className="space-y-2 text-base text-gray-700">
                  {section.links.map((link, linkIndex) => (
                    <li key={linkIndex}>
                      <a href={link.to} onClick={(e) => handleLinkClick(link.to, e)}>
                        {link.name}
                      </a>
                    </li>
                  ))}
          ...
          <div
            ...
            style={{ background: `linear-gradient(135deg, ${colors.purple} 0%, ${colors.blue} 100%)` }}
          >
            © {currentYear} SP Transaction Hub Technology Private Limited. All Rights Reserved.
          </div>
        </div>
      </div>
    </footer>
